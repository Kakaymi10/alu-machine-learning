...
class MultiNormal:
    ...
    def __init__(self, data):
        ...
        Args:
            data (numpy.ndarray): The input dataset of shape (d, n), where n is the number of data points
    ...
    def pdf(self, x):
        ...
        Args:
            x (numpy.ndarray): The data point of shape (d, 1), where d is the number of dimensions.
