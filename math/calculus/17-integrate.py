...
def poly_integral(poly, C=0):
    ...
    Returns:
        list or None: List of coefficients representing the integral of the polynomial.
    ...
    integral.append(poly[0] / 1)  # The integral of a constant term is the term itself
    integral.append(C)

    # If the original polynomial is a constant term (0), set the integral to [C]
    if len(poly) == 1 and poly[0] == 0:
        integral = [C]

    # Convert any floating-point coefficients to integers if they are whole numbers
