...
class GaussianProcess:
    ...
    def __init__(self, X_init, Y_init, l=1, sigma_f=1):
        ...
        - Y_init: numpy.ndarray of shape (t, 1) representing the outputs of the black-box function
        - l: length parameter for the kernel (default is 1)
        - sigma_f: standard deviation given to the output of the black-box function (default is 1)
        """
        self.X = X_init
        self.Y = Y_init
        self.l = l
    ...
    def kernel(self, X1, X2):
        ...
        Returns:
        - numpy.ndarray of shape (m, n) representing the covariance kernel matrix
        """
