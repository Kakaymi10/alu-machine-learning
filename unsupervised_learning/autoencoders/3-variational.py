...
def autoencoder(input_dims, hidden_layers, latent_dims):
    ...
    encoder = keras.models.Model(encoder_input, [z, z_mean, z_log_var], name='encoder')
    ...
    autoencoder = keras.models.Model(autoencoder_input, reconstructed, name='autoencoder')
